...
namespace RapidGUI
{
    public static partial class RGUI
    {
        ...
        internal static object StandardField(object v, Type type) => StandardField(v, type, null);
        
        internal static object StandardField(object v, Type type, GUILayoutOption option)
        {
            object ret = v;
